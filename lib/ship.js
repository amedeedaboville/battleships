...
Cruiser = function Cruiser(start, name, owner, orientation) {
...
Destroyer = function Destroyer(start, name, owner, orientation) {
    Ship.call(this,start, name, owner);
    this.name = "Destroyer"
    this.shipLength = 4;
    this.speed = 8;
...
Radar = function Radar(start, name, owner, orientation) {
    Ship.call(this,start, name, owner);
    this.name = "Radar"
    this.shipLength = 3;
    this.speed = 3;
...
Torpedo = function Torperdo(start, name, owner, orientation) {
    Ship.call(this,start, name, owner);
    this.name = "Torpedo"
    this.length = 3;
    this.speed = 9;
...
MineLayer = function MineLayer(start, name, owner, orientation) {
    Ship.call(this,start, name, owner);
...
Base = function Base(start, name, owner) {
    Ship.call(this,start, name, owner);
    this.name = "Base"
    this.shipLength = 10;
    this.speed = 0;
