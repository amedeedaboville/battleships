Ship = function(start, owner, orientation) {
    this.owner = owner;
    this.health = 0;
    this.speed = 0;
    this.weapons = [];
    ...
    this.initalize = function () {
        ...
        for (var i=0 ; i <= this.length; i++) {
            var x = start[0] + i;
            var y = start[1];
            this.shipSquares.push(new shipSquare(x,y, this.owner, this)); //where PLayer is a string 
        }
...
Cruiser = function(start, owner) {
    Ship.call(this,start, owner);
    this.length = 5;
    this.speed = 10;
...
Destroyer = function(start, owner) {
    Ship.call(this,start, owner);
    this.length = 4;
    this.speed = 8;
