Ship = function(start, id, owner) {
    ...
    this.initalize = function () {
       ...
       //Health is a function of the sum of the health of each square multipled by its armor type. 
        for (var i=0; i < shipSquares.length;i++){
             var square = shipSquare[i];
...
/*
    ...
    this.move = function(destination) {
        //All of the math/error checking should've taken place before this method is called,.
        //So all we need to do is physically move the ship.
