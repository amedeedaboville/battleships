...
//                closestObject[1].__proto__ = new Square();
                //change object's health
//                closestObject[1].setDamaged(true);

                //hitting it sideways
                // var nextSquare = this.getSquareAtPosition( [closestObject[2][0]-1*closestObject[1].orientation[0],
                //                                             closestObject[2][1]-1*closestObject[1].orientation[1]]);
                // if nextSquare()


                // // if (closestObject[2][0], closestObject[2][1])
                // if (closestObject[1].orientation[0] == ship.orientation[1] && 
                //     closestObject.orientation[1] == ship.orientation[0]){
                ...
                //destroy mine
                this.mineSpots.pop([ [closestObject[2][0]],[closestObject[2][1]] ]);
