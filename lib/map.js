...
Map = function() {
    ...
    this.moveShip = function(ship, endPosition){
        ...
        shipToMove.sternPosition = [shipToMove.bowPosition[0] - movementVector[0]*shipToMove.orientation[0], shipToMove.bowPosition[1] - movementVector[1]*shipToMove.orientation[1]]
            for (var i = 0; i < shipToMove.shipLength; i++) {
                ...
                console.log("changing square from position")
                console.log(oldPos)
                console.log("changing square to position")
                console.log(newPos)
