...
Map = function() {
    ...
    this.moveShip = function(ship, endPosition){
        ...
        if (ship.name == 'Kamikaze'){ //these ships have unique movement
    ...
    this.explodeMine = function(position){
        var obj = this.getSquareAtPosition(position);
        if (obj.name != "mine")
            return;
    ...
    */
    ...
    /**
    * NAME: fireCannon(Ship ship, Square targetSquare)
    * PURPOSE: verifies that the target is in range and returns a dangerzone of size 1
    */
    this.fireCannon = function(ship, targetSquare){
        ...
        //The dangerzone is simply one square in this case
        dangerZone.push_back([targetSquare.x, targetSquare.y, damage]);
        return dangerZone;
    }
    ...
    this.fireTorpedo = function(ship, targetSquare){
        //TODO: most of this is wrong since Leo reworked moving
...
//TODO: Maybe move the following to the actions.js class to keep it simple?
    //Update methods
    this.makeShips();
    this.drawGrid();
    return this; 
