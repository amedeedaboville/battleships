    ...
    */
    ...
    this.fireTorpedo = function(ship){
        ...
        //hitting a ship
            ...
            this.damageShip(closestObject[1]);
    ...
    this.damageShip = function(shipObject){
        var ship = this.shipDictionary[shipObject.shipId];
        ship.__proto__ = new Ship();

        //ship takes damage
        ship.takeDamage(shipObject.position,1);
    ...
    this.explodeMine = function(position){
        ...
        if (square && square.mine){
            ...
            //destroy mine
            this.mineSpots.pop([position[0],position[1]]);
        }
        if (this.getSquareAtPosition(position) && this.getSquareAtPosition(position).name == 'ship'){
            console.log(this.shipDictionary[square.shipId]);
            // this.damageShip()
