...
Map = function() {
    ...
    this.getVisibleSquares = function(player){
        ...
        for (ship in this.shipDictionary){
            ...
            console.log(zoneOrientation)
            console.log(zoneRadarRange)
            console.log(zoneStart)

            //Create a zone for the ship in question!
            //var z = new Zone(this.shipDictionary[ship].orientation, this.shipDictionary[ship].radarRange, zoneStart);
