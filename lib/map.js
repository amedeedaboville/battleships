...
Map = function() {
    ...
    this.turnShip = function(ship, turnDirection){
        ...
        if(this.grid.isAreaClear(turnPositions.map(function(pos) {return this.grid.getObjectAtPosition(pos);}.bind(this)))) {
    ...
    this.fireCannon = function(ship, cannonTarget){
        ...
        //var notification = $.UIkit.notify(targetSquare.name + " has been hit at: " + cannonTarget + "by " + targetSquare.owner, {timeout: 3000});
        //var notification = $.UIkit.notify("target has been hit!");
