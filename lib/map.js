    ...
    */
    ...
    this.fireTorpedo = function(ship){
        ...
        var movementVector = this.makeDisplacementVector(ship.bowPosition,endPosition);
            ...
            //find closest object to our ship
            var closestObject = this.getClosestObjectForward(ship.bowPosition, movementVector)[1];

            if (closestObject.name == 'ship'){

                //hitting it sideways
                //TO-DO LEO
                if (closestObject.orientation[0] == ship.orientation[1] && closestObject.orientation[1] == ship.orientation[0]){
            ...
            if (closestObject.name == 'coral'){
                console.log('fired Torpedo at a coral!');
            }
