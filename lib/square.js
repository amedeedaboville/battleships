Square = function(x,y) {
    ...
    this.setDamaged = function(bool){
        if (bool){
            ...
            this.css = this.css.replace(" superArmor", "");
       }
    }

    this.setNormal = function(bool){
        if (bool){
...
shipSquare = function(x,y, shipName, maxHealth, owner, orientation) { //orientation is a vector for direction
    ...
    if (maxHealth == 2) //super armor
        this.css += " superArmor";

    if (this.shipName == "radar1" || this.shipName == "radar2")
        this.css += " radarboat"
